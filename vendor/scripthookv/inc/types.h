...
struct Vector3
{
	...
	{
		return Vector3::Init(this->x + val.x, this->y + val.y, this->z + val.z);
	}
	...
	{
		return Vector3::Init(this->x * val, this->y * val, this->z * val);
	}
	...
	{
		return Vector3::Init(left.y * right.z - left.z * right.y, left.z * right.x - left.x * right.z,
